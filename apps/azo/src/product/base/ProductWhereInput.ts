...
import { DetailProductListRelationFilter } from "../../detailProduct/base/DetailProductListRelationFilter";
...
class ProductWhereInput {
  @ApiProperty({
    required: false,
    type: () => DetailProductListRelationFilter,
  })
  @ValidateNested()
  @Type(() => DetailProductListRelationFilter)
  @IsOptional()
  @Field(() => DetailProductListRelationFilter, {
    nullable: true,
  })
