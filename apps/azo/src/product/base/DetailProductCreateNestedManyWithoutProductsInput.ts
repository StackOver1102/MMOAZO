...
@InputType()
class DetailProductCreateNestedManyWithoutProductsInput {
...
export { DetailProductCreateNestedManyWithoutProductsInput as DetailProductCreateNestedManyWithoutProductsInput };
