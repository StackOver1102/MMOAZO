...
export class ProductResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [DetailProduct], { name: "detailProducts" })
  @nestAccessControl.UseRoles({
  ...
  async findDetailProducts(
    ...
    const results = await this.service.findDetailProducts(parent.id, args);
  ...
  async getService(@graphql.Parent() parent: Product): Promise<Service | null> {
